...
public class DiaryRepository {
    ...
    public Diary findRecentDiaryByUser(Long userPk){
        TypedQuery<Diary> query = em.createQuery("select d from Diary d join d.user u where u.userPk = :userPk order by d.savingDate.savingDate desc", Diary.class)
                .setParameter("userPk",userPk);
    ...
    return em.createQuery("select d from Diary d join d.user u where u.userPk = :userPk and d.savingDate.savingDate = :localDate",Diary.class)
            .setParameter("userPk",userPk)
    ...
    public List<Diary> findBetweenDate(Long userPk, LocalDate startDate, LocalDate endDate){
        return em.createQuery("select d from Diary d join d.user u where u.userPk = :userPk and d.savingDate.savingDate between :startDate and :endDate order by d.savingDate.savingDate")
                .setParameter("userPk",userPk)
